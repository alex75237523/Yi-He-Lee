...
> 2026-07-13 最新更新：「均價低於任一價格即觸發通知」已成為現行正式規則（分支 `fix/reverse-dual-price-moving-average-condition`），
> 取代 2026-07-12「進場價與現價需同時大於或等於均價」及 2026-07-13 稍早 `均價 >= 價格` 的舊方向。現行條件為 MA5／MA20／MA120 任一均價
