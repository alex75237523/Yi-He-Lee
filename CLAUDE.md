...
- 每一條均價（MA5／MA20／MA120）只要 `均價 >= 進場價/平均價` 或 `均價 >= 現價` 其中一項成立就通知（2026-07-13 正式更正比較方向，取代 2026-07-12「兩個價格需同時大於或等於均價」的舊方向）；「現價」串接外部 DDE，「進場價/平均價」非 DDE 欄位；任一欄位無法判讀時列入對應的異常清單告知，不得判斷、不得混用、不得互相代替。
...
>
> **2026-07-13 正式更正比較方向**：2026-07-12 的雙價格 AND 規則（價格同時大於或等於均價）已被取代。現行規則為 MA5／MA20／MA120 任一均價只要大於或等於「進場價/平均價」或「現價」其中一項即成立；MA60 不參與觸發。詳見 `docs/01_需求與規則.md`、`docs/05_異動紀錄.md`。
